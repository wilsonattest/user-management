# [ADR-0004] Implement WebSockets for authentication
...
| Date        | 2025-04-20 |
| Status      | Proposed |
| Deciders    | Alice Chen, Alice Chen, Eva Martinez |
...
We will use RabbitMQ for our authentication needs. This technology provides the features we need and aligns with our team's expertise.
