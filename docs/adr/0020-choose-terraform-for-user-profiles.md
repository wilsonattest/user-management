# [ADR-0020] Choose Terraform for user-profiles
...
| Date        | 2024-05-02 |
| Status      | Superseded |
| Deciders    | Eva Martinez, Jack Anderson, Frank Wilson |
...
We will use Node.js for our user-profiles needs. This technology provides the features we need and aligns with our team's expertise.
