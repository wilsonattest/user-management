# [ADR-0032] Implement GraphQL for user-profiles
...
We will use Elasticsearch for our user-profiles needs. This technology provides the features we need and aligns with our team's expertise.
