# [ADR-0049] Integrate REST-API for session-handling
...
| Date        | 2023-06-17 |
| Status      | Accepted |
| Deciders    | Grace Lee, Alice Chen, Alice Chen |
...
We will use gRPC for our session-handling needs. This technology provides the features we need and aligns with our team's expertise.
