# [ADR-0006] Use RabbitMQ for gdpr-compliance
...
We will use React for our gdpr-compliance needs. This technology provides the features we need and aligns with our team's expertise.
