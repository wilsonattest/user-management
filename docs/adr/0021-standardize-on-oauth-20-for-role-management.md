# [ADR-0021] Standardize-on OAuth-2.0 for role-management
...
We will use Redis for our role-management needs. This technology provides the features we need and aligns with our team's expertise.
