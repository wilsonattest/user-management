# [ADR-0082] Use RabbitMQ for password-policy
...
We will use Redis for our password-policy needs. This technology provides the features we need and aligns with our team's expertise.
