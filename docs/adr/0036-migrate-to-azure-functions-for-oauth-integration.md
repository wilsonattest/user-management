# [ADR-0036] Migrate-to Azure-Functions for oauth-integration
...
| Date        | 2024-07-09 |
| Status      | Accepted |
| Deciders    | Grace Lee, Iris Taylor, Alice Chen |
...
We will use PostgreSQL for our oauth-integration needs. This technology provides the features we need and aligns with our team's expertise.
