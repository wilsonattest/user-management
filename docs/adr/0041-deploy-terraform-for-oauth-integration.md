# [ADR-0041] Deploy Terraform for oauth-integration
...
We will use JWT for our oauth-integration needs. This technology provides the features we need and aligns with our team's expertise.
