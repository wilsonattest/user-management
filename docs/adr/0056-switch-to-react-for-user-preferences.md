# [ADR-0056] Switch-to React for user-preferences
...
| Date        | 2025-07-15 |
| Status      | Proposed |
| Deciders    | Jack Anderson, Iris Taylor, Alice Chen |
...
We will use GraphQL for our user-preferences needs. This technology provides the features we need and aligns with our team's expertise.
