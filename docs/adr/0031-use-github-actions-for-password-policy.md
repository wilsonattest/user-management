# [ADR-0031] Use GitHub-Actions for password-policy
...
| Date        | 2024-08-02 |
| Status      | Accepted |
| Deciders    | Carol Johnson, Henry Brown, Henry Brown |
...
We will use PostgreSQL for our password-policy needs. This technology provides the features we need and aligns with our team's expertise.
