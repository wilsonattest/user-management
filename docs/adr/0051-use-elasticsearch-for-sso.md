# [ADR-0051] Use Elasticsearch for sso
...
| Date        | 2024-05-05 |
| Status      | Superseded |
| Deciders    | Eva Martinez, David Kim, Eva Martinez |

## Context

Our sso implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use DotNet-Core for our sso needs. This technology provides the features we need and aligns with our team's expertise.
