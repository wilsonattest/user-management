# [ADR-0013] Deploy JWT for user-preferences
...
| Date        | 2023-12-17 |
| Status      | Accepted |
| Deciders    | Carol Johnson, Grace Lee |
...
We will use Elasticsearch for our user-preferences needs. This technology provides the features we need and aligns with our team's expertise.
