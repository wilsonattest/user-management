# [ADR-0022] Migrate-to Terraform for user-profiles
...
| Date        | 2024-09-10 |
| Status      | Accepted |
| Deciders    | Henry Brown, Eva Martinez, David Kim |
...
We will use HashiCorp-Vault for our user-profiles needs. This technology provides the features we need and aligns with our team's expertise.
