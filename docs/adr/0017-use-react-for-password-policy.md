# [ADR-0017] Use React for password-policy
...
| Date        | 2023-08-05 |
| Status      | Proposed |
| Deciders    | Eva Martinez, Bob Smith, Iris Taylor |
...
We will use gRPC for our password-policy needs. This technology provides the features we need and aligns with our team's expertise.
