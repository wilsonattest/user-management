# [ADR-0040] Deploy GitHub-Actions for authorization
...
We will use Redis for our authorization needs. This technology provides the features we need and aligns with our team's expertise.
