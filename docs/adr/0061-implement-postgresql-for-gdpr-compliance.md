# [ADR-0061] Implement PostgreSQL for gdpr-compliance
...
We will use gRPC for our gdpr-compliance needs. This technology provides the features we need and aligns with our team's expertise.
