# [ADR-0048] Choose TypeScript for user-profiles
...
| Date        | 2024-02-23 |
| Status      | Superseded |
| Deciders    | Iris Taylor, Alice Chen, Henry Brown |
...
We will use Terraform for our user-profiles needs. This technology provides the features we need and aligns with our team's expertise.
