# [ADR-0008] Implement GitHub-Actions for account-recovery
...
| Date        | 2023-07-25 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Alice Chen, Jack Anderson |
...
We will use Vue.js for our account-recovery needs. This technology provides the features we need and aligns with our team's expertise.
