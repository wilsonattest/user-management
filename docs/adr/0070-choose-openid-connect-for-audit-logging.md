# [ADR-0070] Choose OpenID-Connect for audit-logging
...
We will use Python for our audit-logging needs. This technology provides the features we need and aligns with our team's expertise.
