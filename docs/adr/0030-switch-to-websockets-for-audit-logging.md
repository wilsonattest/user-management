# [ADR-0030] Switch-to WebSockets for audit-logging
...
We will use Redis for our audit-logging needs. This technology provides the features we need and aligns with our team's expertise.
