# [ADR-0068] Deploy MongoDB for gdpr-compliance
...
We will use GitHub-Actions for our gdpr-compliance needs. This technology provides the features we need and aligns with our team's expertise.
