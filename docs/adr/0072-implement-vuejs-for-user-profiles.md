# [ADR-0072] Implement Vue.js for user-profiles
...
We will use AWS-Lambda for our user-profiles needs. This technology provides the features we need and aligns with our team's expertise.
