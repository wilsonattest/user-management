# [ADR-0069] Integrate OpenID-Connect for sso
...
We will use gRPC for our sso needs. This technology provides the features we need and aligns with our team's expertise.
