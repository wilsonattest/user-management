# [ADR-0065] Switch-to DotNet-Core for authorization
...
We will use OAuth-2.0 for our authorization needs. This technology provides the features we need and aligns with our team's expertise.
