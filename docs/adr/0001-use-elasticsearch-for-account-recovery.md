# [ADR-0001] Use Elasticsearch for account-recovery
...
We will use Terraform for our account-recovery needs. This technology provides the features we need and aligns with our team's expertise.
