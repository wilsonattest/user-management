# [ADR-0046] Use Azure-Functions for authorization
...
| Date        | 2023-11-28 |
| Status      | Superseded |
| Deciders    | Bob Smith, Alice Chen, Bob Smith |
...
We will use JWT for our authorization needs. This technology provides the features we need and aligns with our team's expertise.
