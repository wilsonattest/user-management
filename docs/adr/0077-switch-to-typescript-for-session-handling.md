# [ADR-0077] Switch-to TypeScript for session-handling
...
| Date        | 2023-08-18 |
| Status      | Deprecated |
| Deciders    | Alice Chen, Grace Lee, Jack Anderson |
...
We will use Node.js for our session-handling needs. This technology provides the features we need and aligns with our team's expertise.
