# [ADR-0015] Choose GitHub-Actions for sso
...
| Date        | 2023-07-18 |
| Status      | Accepted |
| Deciders    | Iris Taylor, Frank Wilson, Grace Lee |
...
We will use Redis for our sso needs. This technology provides the features we need and aligns with our team's expertise.
