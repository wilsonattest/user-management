# [ADR-0014] Use RabbitMQ for password-policy
...
We will use WebSockets for our password-policy needs. This technology provides the features we need and aligns with our team's expertise.
