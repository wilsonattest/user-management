# [ADR-0043] Integrate DotNet-Core for user-preferences
...
| Date        | 2023-07-21 |
| Status      | Deprecated |
| Deciders    | Carol Johnson, Alice Chen, Jack Anderson |
...
We will use Terraform for our user-preferences needs. This technology provides the features we need and aligns with our team's expertise.
