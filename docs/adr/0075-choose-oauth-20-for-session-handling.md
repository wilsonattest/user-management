# [ADR-0075] Choose OAuth-2.0 for session-handling
...
We will use AWS-Lambda for our session-handling needs. This technology provides the features we need and aligns with our team's expertise.
