# [ADR-0016] Integrate Vue.js for role-management
...
We will use RabbitMQ for our role-management needs. This technology provides the features we need and aligns with our team's expertise.
