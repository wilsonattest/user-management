# [ADR-0057] Adopt GraphQL for oauth-integration
...
We will use TypeScript for our oauth-integration needs. This technology provides the features we need and aligns with our team's expertise.
