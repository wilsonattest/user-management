# [ADR-0062] Adopt Docker for gdpr-compliance
...
We will use Azure-Functions for our gdpr-compliance needs. This technology provides the features we need and aligns with our team's expertise.
