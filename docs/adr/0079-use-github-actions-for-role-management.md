# [ADR-0079] Use GitHub-Actions for role-management
...
| Date        | 2024-09-16 |
| Status      | Accepted |
| Deciders    | Iris Taylor, Frank Wilson, Alice Chen |

## Context

Our role-management implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use GraphQL for our role-management needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for role-management
