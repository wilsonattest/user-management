# [ADR-0081] Switch-to Vue.js for user-profiles
...
| Date        | 2025-06-17 |
| Status      | Accepted |
| Deciders    | Iris Taylor, Frank Wilson, Eva Martinez |
...
We will use GraphQL for our user-profiles needs. This technology provides the features we need and aligns with our team's expertise.
