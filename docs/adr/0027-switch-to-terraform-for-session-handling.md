# [ADR-0027] Switch-to Terraform for session-handling
...
| Date        | 2024-07-05 |
| Status      | Proposed |
| Deciders    | Bob Smith, Bob Smith, Henry Brown |
...
We will use WebSockets for our session-handling needs. This technology provides the features we need and aligns with our team's expertise.
