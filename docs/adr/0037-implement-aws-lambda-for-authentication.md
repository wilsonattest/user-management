# [ADR-0037] Implement AWS-Lambda for authentication
...
| Date        | 2024-12-09 |
| Status      | Proposed |
| Deciders    | Carol Johnson, Frank Wilson, Iris Taylor |
...
We will use Azure-Functions for our authentication needs. This technology provides the features we need and aligns with our team's expertise.
