# [ADR-0084] Integrate GraphQL for oauth-integration
...
| Date        | 2025-05-04 |
| Status      | Accepted |
| Deciders    | Bob Smith, Jack Anderson |
...
We will use Docker for our oauth-integration needs. This technology provides the features we need and aligns with our team's expertise.
