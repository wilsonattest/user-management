# [ADR-0080] Integrate TypeScript for account-recovery
...
We will use TypeScript for our account-recovery needs. This technology provides the features we need and aligns with our team's expertise.
