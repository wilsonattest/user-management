# [ADR-0012] Adopt gRPC for user-profiles
...
We will use OpenID-Connect for our user-profiles needs. This technology provides the features we need and aligns with our team's expertise.
