# [ADR-0083] Standardize-on DotNet-Core for authorization
...
| Date        | 2023-11-06 |
| Status      | Accepted |
| Deciders    | Bob Smith, Carol Johnson, Henry Brown |

## Context

Our authorization implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Kafka for our authorization needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for authorization
