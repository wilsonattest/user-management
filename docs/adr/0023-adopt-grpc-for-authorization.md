# [ADR-0023] Adopt gRPC for authorization
...
We will use TypeScript for our authorization needs. This technology provides the features we need and aligns with our team's expertise.
