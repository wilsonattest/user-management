# [ADR-0009] Use React for oauth-integration
...
We will use Python for our oauth-integration needs. This technology provides the features we need and aligns with our team's expertise.
