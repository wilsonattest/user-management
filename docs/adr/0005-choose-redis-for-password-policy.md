# [ADR-0005] Choose Redis for password-policy
...
| Date        | 2023-01-19 |
| Status      | Proposed |
| Deciders    | Iris Taylor, Carol Johnson, Grace Lee |
...
We will use OpenID-Connect for our password-policy needs. This technology provides the features we need and aligns with our team's expertise.
