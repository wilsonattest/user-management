# [ADR-0038] Implement Redis for audit-logging
...
| Date        | 2025-06-17 |
| Status      | Deprecated |
| Deciders    | Bob Smith, Eva Martinez, Eva Martinez |
...
We will use HashiCorp-Vault for our audit-logging needs. This technology provides the features we need and aligns with our team's expertise.
