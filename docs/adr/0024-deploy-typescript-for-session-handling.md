# [ADR-0024] Deploy TypeScript for session-handling
...
We will use Redis for our session-handling needs. This technology provides the features we need and aligns with our team's expertise.
