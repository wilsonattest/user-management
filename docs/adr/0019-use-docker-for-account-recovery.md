# [ADR-0019] Use Docker for account-recovery
...
| Date        | 2024-08-24 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Alice Chen, Carol Johnson |
...
We will use gRPC for our account-recovery needs. This technology provides the features we need and aligns with our team's expertise.
