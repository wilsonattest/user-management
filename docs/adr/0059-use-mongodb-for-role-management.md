# [ADR-0059] Use MongoDB for role-management
...
We will use AWS-Lambda for our role-management needs. This technology provides the features we need and aligns with our team's expertise.
