# [ADR-0050] Implement HashiCorp-Vault for password-policy
...
| Date        | 2023-10-04 |
| Status      | Proposed |
| Deciders    | David Kim, Eva Martinez |
...
We will use Elasticsearch for our password-policy needs. This technology provides the features we need and aligns with our team's expertise.
