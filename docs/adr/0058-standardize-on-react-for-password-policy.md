# [ADR-0058] Standardize-on React for password-policy
...
| Date        | 2023-08-29 |
| Status      | Proposed |
| Deciders    | Grace Lee, Jack Anderson, David Kim |
...
We will use Kafka for our password-policy needs. This technology provides the features we need and aligns with our team's expertise.
