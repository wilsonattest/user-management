# [ADR-0054] Deploy Docker for role-management
...
We will use TypeScript for our role-management needs. This technology provides the features we need and aligns with our team's expertise.
