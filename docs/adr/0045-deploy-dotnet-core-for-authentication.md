# [ADR-0045] Deploy DotNet-Core for authentication
...
| Date        | 2023-04-05 |
| Status      | Accepted |
| Deciders    | David Kim, Henry Brown, Bob Smith |
...
We will use MongoDB for our authentication needs. This technology provides the features we need and aligns with our team's expertise.
