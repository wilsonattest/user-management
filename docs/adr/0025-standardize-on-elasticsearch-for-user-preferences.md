# [ADR-0025] Standardize-on Elasticsearch for user-preferences
...
| Date        | 2025-06-28 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Henry Brown, Bob Smith |
...
We will use GitHub-Actions for our user-preferences needs. This technology provides the features we need and aligns with our team's expertise.
