# [ADR-0018] Deploy WebSockets for user-profiles
...
| Date        | 2025-02-22 |
| Status      | Proposed |
| Deciders    | Grace Lee, Alice Chen, Henry Brown |
...
We will use MongoDB for our user-profiles needs. This technology provides the features we need and aligns with our team's expertise.
