# [ADR-0078] Implement JWT for session-handling
...
| Date        | 2024-11-22 |
| Status      | Proposed |
| Deciders    | Alice Chen, Grace Lee, Bob Smith |
...
We will use Docker for our session-handling needs. This technology provides the features we need and aligns with our team's expertise.
